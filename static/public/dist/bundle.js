...
(function (global) {
  function buildBemXjst(libs) {
    ...
    var api = new bemhtml({
      "exportName": "bemhtml",
      "escapeContent": true,
      "to": "/home/astronaut/gitHub/rowbot/three_in_a_boat_front/static/public/js"
    });
...
/* harmony import */ var _views_components_chat_button_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_views_components_chat_button_js__WEBPACK_IMPORTED_MODULE_0__);
...
var chat = new _views_components_small_chat_js__WEBPACK_IMPORTED_MODULE_3__["default"](application);
...
function () {
  ...
  _createClass(SmallChat, [{
    ...
    value: function _initEvents() {
      ...
      var chatBlock = this.parent.getElementsByClassName('small-chat_open')[0];
      ...
      this.button.btn.onclick = function () {
        console.log('text');
...
function (_View) {
  ...
  _createClass(MsgButtonView, [{
    ...
    value: function render() {
      ...
      this.parent.insertAdjacentHTML('beforeend', bemhtml.apply(draw));
      this.btn = this.parent.getElementsByClassName('small-chat__btn')[0];

      this.btn.onclick = function () {
        console.log('text'); // this.button = undefined;

        _this.parent.getElementsByClassName('small-chat__btn')[0].hidden = true;
      }; // parent.removeChil
